...
declare META_PROGRAM_DESCRIPTION="This is a wrapper of the filter script in the source code directory"
...
init() {
	...
	# We found the clean filter, now replace us with them
	exec "${filter_executable}"
